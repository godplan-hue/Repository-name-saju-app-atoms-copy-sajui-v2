  ...
  const shareLanding = () => {
    ...
    if (k?.isInitialized() && k?.Share) {
      try {
        k.Share.sendDefault({
          objectType: "feed",
          content: { title: "📡 연락통신 — 관계 신호 분석", description: text, imageUrl: "https://images.unsplash.com/photo-1591347887817-173e3d5c4891?w=1200&q=80", link: { mobileWebUrl: url, webUrl: url } },
