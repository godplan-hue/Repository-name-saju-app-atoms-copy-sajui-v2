...
const GRID_APPS = [
  ...
  { href: "/gwangyeoradar", emoji: "📡", label: "연락기록통계 점운", sub: "연락 패턴 27개 지표 분석", desc: "놓친 신호 · 관계 온도 · 회복가능성", badge: "990원·24h", color: "#9333ea", bg: "linear-gradient(145deg,#f3e8ff,#e9d5ff)", img: "https://images.unsplash.com/photo-1591347887817-173e3d5c4891?w=800&q=80" },
