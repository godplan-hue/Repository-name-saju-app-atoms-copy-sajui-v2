...
const GRID_APPS = [
  ...
  { href: "/battle",     emoji: "❤️", label: "이상형월드컵", sub: "연애 유형 8라운드 배틀", desc: "열정형·헌신형·자유형·독립형", badge: "무료/990원·24h", color: "#e11d48", bg: "linear-gradient(145deg,#fff1f2,#fecdd3)", img: "" },
  { href: "/movie",      emoji: "🎬", label: "인생이영화라면", sub: "오늘 내 인생 장르는?", desc: "로코·힐링·직장코미디·역경", badge: "무료/990원·24h", color: "#d97706", bg: "linear-gradient(145deg,#fffbeb,#fde68a)", img: "" },
  { href: "/style",      emoji: "✨", label: "추구미",    sub: "나의 패션 코어 분석",   desc: "Y2K·로맨틱·다크·미니멀코어", badge: "무료/990원·24h", color: "#7c3aed", bg: "linear-gradient(145deg,#faf5ff,#e9d5ff)", img: "" },
  { href: "/work",       emoji: "💪", label: "직장버티기", sub: "오늘 직장 생존 점수",  desc: "상사 유형 + 하루 퀴즈",     badge: "무료/990원·24h", color: "#2563eb", bg: "linear-gradient(145deg,#eff6ff,#bfdbfe)", img: "" },
