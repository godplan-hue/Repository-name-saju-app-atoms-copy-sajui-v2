...
const DATA: Entry[] = [
  { slug:"gamjung-diary", title:"감정일기 | 점운 감정일기", desc:"오늘의 감정을 일기로 남기고, 사주 오행으로 감정의 흐름을 파악하세요. 무료 감정 기록과 오행 분석 서비스입니다.", h1:"감정일기 — 오행으로 보는 내 감정의 흐름", sub:"오늘 감정을 기록하고 사주 오행으로 감정 흐름 파악", emoji:"📔" },
  { slug:"free-gamjung", title:"무료 감정일기 | 점운 감정일기", desc:"무료 감정일기 — 회원가입 없이 즉시 오늘의 감정을 기록하고 오행 기질로 감정을 분석하세요.", h1:"무료 감정일기 — 즉시 감정 기록과 오행 분석", sub:"회원가입 없이 즉시 감정 기록·오행 분석 무료 서비스", emoji:"🆓" },
  ...
  { slug:"gamjung-free", title:"무료 감정일기 | 점운 감정일기", desc:"무료 감정일기 — 점운 감정일기로 오행 기질에 맞는 감정 분석을 무료로 시작하세요.", h1:"무료 감정일기 — 오행 기질 감정 분석 무료 시작", sub:"점운 무료 감정일기로 오행 기질 맞춤 감정 분석 시작", emoji:"🎁" },
