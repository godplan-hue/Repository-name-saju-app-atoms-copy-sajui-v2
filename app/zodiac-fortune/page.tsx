...
export const metadata: Metadata = {
  title: `띠별 운세 | 점운 — 내 띠로 보는 ${CURRENT_YEAR}년 운세`,
  description: `띠별 운세를 확인해보세요. 쥐·소·호랑이·토끼·용·뱀·말·양·원숭이·닭·개·돼지 띠별 ${CURRENT_YEAR}년 운세를 AI로 분석해드려요.`,
  keywords: ["띠별 운세", "띠 운세", `${CURRENT_YEAR} 띠별운세`, "띠 사주", "12띠 운세", "띠별 사주"],
  openGraph: { title: "띠별 운세 — 점운", description: `내 띠로 보는 ${CURRENT_YEAR}년 운세. AI 사주 정밀 분석.`, url: "https://jeomun.com/zodiac-fortune" },
...
const faqs = [
  ...
  { q: "올해 좋은 띠가 있나요?", a: "그 해의 세운(歲運)에 따라 화(火)·수(水) 등 오행 기운이 강해지고, 그 기운과 잘 맞는 띠는 유리하고 충(沖) 관계인 띠는 조심해야 해요. 정확한 건 내 사주 전체를 봐야 알 수 있어요." },
  ...
  return (
    <main style={{ minHeight: "100vh", background: "#fff7ed", fontFamily: "'Apple SD Gothic Neo', 'Malgun Gothic', sans-serif", color: "#1f2937" }}>
      <div style={{ background: "linear-gradient(135deg, #fed7aa, #fff7ed)", padding: "60px 20px 48px", textAlign: "center" }}>
        ...
        <h1 style={{ fontSize: "clamp(26px,5vw,40px)", fontWeight: 900, color: "#1f2937", margin: "0 0 12px", lineHeight: 1.25 }}>내 띠로 보는<br />{CURRENT_YEAR}년 운세</h1>
