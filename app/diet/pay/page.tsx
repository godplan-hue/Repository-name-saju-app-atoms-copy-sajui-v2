...
export default function DietPayPage() {
  ...
  const payToss = async () => {
    ...
    try {
      ...
      const orderId = `diet-toss-${Date.now()}`;
      const cleanMobile = mobile.replace(/\D/g,"");
  ...
  return (
    <div style={S.wrap}>
      <div style={S.inner}>
        ...
        <div style={{ background:"linear-gradient(135deg,#1a2e1a,#1b3a1b)", border:"1px solid rgba(101,163,13,0.4)", borderRadius:18, padding:"20px 18px", marginBottom:16, textAlign:"center" }}>
