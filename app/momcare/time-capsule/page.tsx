    ...
    if (!momcareUnlocked) return (
      <div style={{ minHeight: "100vh", background: "#f0f7ff", fontFamily: "'Apple SD Gothic Neo', 'Malgun Gothic', sans-serif", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
        <div style={{ textAlign: "center", maxWidth: 320 }}>
          ...
          <a href="/main-v2/pay?amount=990" style={{ display: "block", background: "linear-gradient(135deg, #f97316, #fb923c)", color: "white", padding: "14px", borderRadius: 14, fontSize: 15, fontWeight: 900, textDecoration: "none", marginBottom: 12 }}>{momcareExpired ? "사주 990원으로 30일 재활성화 →" : "사주 990원 결제하기 →"}</a>
    ...
    <div style={{ minHeight: "100vh", background: "#f0f7ff", fontFamily: "'Apple SD Gothic Neo', 'Malgun Gothic', sans-serif" }}>
      <nav style={{ background: "white", borderBottom: "1px solid #e5e7eb", padding: "14px 24px", display: "flex", justifyContent: "space-between", alignItems: "center", position: "sticky", top: 0, zIndex: 50 }}>
        ...
        {momcareUnlocked ? (
          ...
          <a href="/main-v2/pay?amount=990" style={{ background: "#fed7aa", color: "#c2410c", borderRadius: 12, padding: "8px 14px", fontSize: 12, fontWeight: 700, textDecoration: "none" }}>{momcareExpired ? "🔒 재활성화" : "🔒 결제하기"}</a>
        )}
      </nav>
      <div style={{ maxWidth: 640, margin: "0 auto", padding: "24px 20px" }}>
        {!hasPhone && (
        ...
        {!momcareUnlocked && (
          <div style={{ background: "#fff7ed", border: "1px solid #fed7aa", borderRadius: 12, padding: "14px 16px", marginBottom: 16 }}>
            ...
            <p style={{ fontSize: 12, color: "#78350f", margin: "0 0 10px", lineHeight: 1.6 }}>{momcareExpired ? "기존 편지는 계속 읽을 수 있어요. 새 편지를 쓰려면 재활성화해주세요." : "사주 990원 결제하면 맘케어 30일 이용 가능해요."}</p>
            <a href="/main-v2/pay?amount=990" style={{ display: "inline-block", background: "linear-gradient(135deg, #f97316, #fb923c)", color: "white", fontSize: 13, fontWeight: 900, padding: "10px 20px", borderRadius: 14, textDecoration: "none" }}>{momcareExpired ? "사주 990원으로 30일 재활성화 →" : "사주 990원 결제하기 →"}</a>
          </div>
        )}
