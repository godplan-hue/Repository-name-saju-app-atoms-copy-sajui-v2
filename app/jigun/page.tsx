  ...
  return (
    <div style={{ minHeight: "100vh", background: "#030014", fontFamily: "'Apple SD Gothic Neo','Malgun Gothic',sans-serif", color: "white" }}>
      ...
      <footer style={{ padding: "32px 20px 24px", textAlign: "center" }}>
        <div style={{ maxWidth: 360, margin: "0 auto", padding: "18px 16px", borderRadius: 20, background: "rgba(255,255,255,0.07)", border: "1px solid rgba(255,255,255,0.12)" }}>
          <p style={{ color: "rgba(255,255,255,0.5)", fontSize: 11, fontWeight: 700, margin: "0 0 8px" }}>© 2026 점운 · AI 동양 운세 분석</p>
          <div style={{ color: "rgba(255,255,255,0.4)", fontSize: 10.5, fontWeight: 600, lineHeight: 1.8, marginBottom: 12 }}>
          ...
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap", justifyContent: "center", marginBottom: 10 }}>
            ...
            <a href="mailto:info@jeomun.com?subject=점운 문의" style={{ display: "inline-block", padding: "6px 16px", border: "1.5px solid rgba(255,255,255,0.3)", borderRadius: 20, color: "rgba(255,255,255,0.6)", textDecoration: "none", fontWeight: 800, fontSize: 11 }}>📧 이메일 문의</a>
          </div>
          <div style={{ fontSize: 11 }}>
            <a href="/terms" style={{ color: "rgba(255,255,255,0.5)", textDecoration: "none", fontWeight: 600 }}>이용약관</a>
            <span style={{ color: "rgba(255,255,255,0.2)", margin: "0 8px" }}>|</span>
            <a href="/privacy" style={{ color: "rgba(255,255,255,0.5)", textDecoration: "none", fontWeight: 600 }}>개인정보처리방침</a>
            <span style={{ color: "rgba(255,255,255,0.2)", margin: "0 8px" }}>|</span>
            <a href="/refund" style={{ color: "rgba(255,255,255,0.5)", textDecoration: "none", fontWeight: 600 }}>환불정책</a>
          </div>
        </div>
      </footer>
    </div>
