        ...
        <div style={{ background: "rgba(108,64,200,0.15)", padding: 30, borderRadius: 12, border: "1px solid rgba(139,92,246,0.3)" }}>
          ...
          <section style={{ marginBottom: 30, padding: 16, background: "rgba(139,92,246,0.15)", borderRadius: 8, border: "1px solid rgba(139,92,246,0.4)" }}>
            ...
            <div style={{ color: "#f5f5f5", fontSize: 13, fontWeight: 700, lineHeight: 2 }}>
              ...
              <p style={{ margin: "0 0 6px" }}>👶 <span style={{ color: "#f9a8d4" }}>점운 맘케어</span> — <span style={{ color: "#4ade80" }}>사주 결제 시 무료 제공</span> (별도 결제 없음)</p>
              <p style={{ margin: 0 }}>🎓 <span style={{ color: "#fbbf24" }}>점운 합격 (합격자소서)</span> — 유료 (9,900원 / 29,900원)</p>
            </div>
            <p style={{ color: "#f97316", fontSize: 12, fontWeight: 700, margin: "12px 0 0" }}>※ 꿈해몽·직운·맘케어는 사주 990원 이상 결제 완료 시 자동으로 24시간~30일 이용 가능해집니다.</p>
          </section>
