...
const DATA: Entry[] = [
  ...
  { slug:"intj-relationship", title:"INTJ 연애 스타일 | 점운 MBTI", desc:"INTJ 연애 스타일 — 완벽주의 전략가 INTJ가 연애에서 보이는 행동 패턴과 이상적인 파트너를 분析합니다.", h1:"INTJ 연애 스타일 — 전략가의 사랑 방식", sub:"INTJ 완벽주의 전략가의 연애 패턴과 이상형 분析", emoji:"💙" },
  { slug:"infp-relationship", title:"INFP 연애 스타일 | 점운 MBTI", desc:"INFP 연애 스타일 — 이상주의 중재자 INFP가 연애에서 보이는 행동 패턴과 이상적인 파트너를 분析합니다.", h1:"INFP 연애 스타일 — 중재자의 사랑 방식", sub:"INFP 이상주의 중재자의 연애 패턴과 이상형 분析", emoji:"💜" },
  { slug:"enfp-relationship", title:"ENFP 연애 스타일 | 점운 MBTI", desc:"ENFP 연애 스타일 — 열정적 활동가 ENFP가 연애에서 보이는 행동 패턴과 이상적인 파트너를 분析합니다.", h1:"ENFP 연애 스타일 — 활동가의 사랑 방식", sub:"ENFP 열정적 활동가의 연애 패턴과 이상형 분析", emoji:"💛" },
  { slug:"istj-relationship", title:"ISTJ 연애 스타일 | 점운 MBTI", desc:"ISTJ 연애 스타일 — 청렴결백한 논리주의자 ISTJ가 연애에서 보이는 행동 패턴과 이상형을 분析합니다.", h1:"ISTJ 연애 스타일 — 논리주의자의 사랑 방식", sub:"ISTJ 청렴결백한 논리주의자의 연애 패턴 분析", emoji:"💚" },
  { slug:"entp-relationship", title:"ENTP 연애 스타일 | 점운 MBTI", desc:"ENTP 연애 스타일 — 뜨거운 논쟁을 즐기는 변론가 ENTP의 연애 패턴과 이상형을 분析합니다.", h1:"ENTP 연애 스타일 — 변론가의 사랑 방식", sub:"ENTP 변론가의 연애 패턴과 이상형 분析", emoji:"🧡" },
  { slug:"infj-relationship", title:"INFJ 연애 스타일 | 점운 MBTI", desc:"INFJ 연애 스타일 — 선의의 옹호자 INFJ가 연애에서 보이는 깊은 감정과 이상적인 파트너를 분析합니다.", h1:"INFJ 연애 스타일 — 옹호자의 사랑 방식", sub:"INFJ 선의의 옹호자의 연애 패턴과 이상형 분析", emoji:"💜" },
  { slug:"intj-career", title:"INTJ 직업 추천 | 점운 MBTI", desc:"INTJ에게 맞는 직업 — 전략적 사고와 독립적 업무 스타일을 살리는 INTJ 최적 직업을 분析합니다.", h1:"INTJ 직업 추천 — 전략가에게 맞는 직업", sub:"INTJ 전략적 사고를 살리는 최적 직업 분析", emoji:"💼" },
  { slug:"infp-career", title:"INFP 직업 추천 | 점운 MBTI", desc:"INFP에게 맞는 직업 — 가치관과 창의성을 살리는 INFP 최적 직업과 커리어 방향을 분析합니다.", h1:"INFP 직업 추천 — 중재자에게 맞는 직업", sub:"INFP 가치관과 창의성을 살리는 최적 직업 분析", emoji:"🎨" },
  { slug:"enfj-career", title:"ENFJ 직업 추천 | 점운 MBTI", desc:"ENFJ에게 맞는 직업 — 사람과 함께 성장하는 것을 즐기는 ENFJ 최적 직업을 분析합니다.", h1:"ENFJ 직업 추천 — 주인공에게 맞는 직업", sub:"ENFJ 사람 중심 가치를 살리는 최적 직업 분析", emoji:"👥" },
  { slug:"istp-career", title:"ISTP 직업 추천 | 점운 MBTI", desc:"ISTP에게 맞는 직업 — 실용적이고 독립적인 ISTP의 최적 직업과 커리어 방향을 분析합니다.", h1:"ISTP 직업 추천 — 장인에게 맞는 직업", sub:"ISTP 실용적 독립성을 살리는 최적 직업 분析", emoji:"🔧" },
  { slug:"estp-career", title:"ESTP 직업 추천 | 점운 MBTI", desc:"ESTP에게 맞는 직업 — 현재에 집중하고 행동력이 강한 ESTP 최적 직업을 분析합니다.", h1:"ESTP 직업 추천 — 사업가에게 맞는 직업", sub:"ESTP 행동력을 살리는 최적 직업 분析", emoji:"⚡" },
  { slug:"intj-stress", title:"INTJ 스트레스 해소법 | 점운 MBTI", desc:"INTJ 스트레스 해소법 — 완벽주의 전략가 INTJ가 스트레스를 받을 때 보이는 패턴과 효과적 해소법.", h1:"INTJ 스트레스 해소법 — 전략가의 회복 방법", sub:"INTJ 스트레스 패턴과 효과적 해소 방법 분析", emoji:"🧘" },
  { slug:"infp-stress", title:"INFP 스트레스 해소법 | 점운 MBTI", desc:"INFP 스트레스 해소법 — 이상주의 중재자 INFP가 스트레스를 받을 때 보이는 패턴과 해소법.", h1:"INFP 스트레스 해소법 — 중재자의 회복 방법", sub:"INFP 스트레스 패턴과 효과적 해소 방법 분析", emoji:"🌿" },
  { slug:"enfp-stress", title:"ENFP 스트레스 해소법 | 점운 MBTI", desc:"ENFP 스트레스 해소법 — 열정적 활동가 ENFP가 스트레스를 받을 때 보이는 패턴과 해소법.", h1:"ENFP 스트레스 해소법 — 활동가의 회복 방법", sub:"ENFP 스트레스 패턴과 효과적 해소 방법 분析", emoji:"🌈" },
  { slug:"istj-stress", title:"ISTJ 스트레스 해소법 | 점운 MBTI", desc:"ISTJ 스트레스 해소법 — 청렴결백 논리주의자 ISTJ가 스트레스를 받을 때의 패턴과 해소법.", h1:"ISTJ 스트레스 해소법 — 논리주의자의 회복 방법", sub:"ISTJ 스트레스 패턴과 효과적 해소 방법 분析", emoji:"🏔️" },
  { slug:"mbti-morning-routine", title:"MBTI 아침 루틴 | 점운 MBTI", desc:"MBTI 유형별 아침 루틴 — 각 MBTI 유형에 맞는 이상적인 아침 루틴과 시작 방법을 분析합니다.", h1:"MBTI 아침 루틴 — 유형별 이상적 아침 시작", sub:"MBTI 유형별 아침 루틴과 최적 시작 방법 분析", emoji:"🌅" },
  { slug:"mbti-love-language", title:"MBTI 사랑의 언어 | 점운 MBTI", desc:"MBTI 유형별 사랑의 언어 — 각 유형이 사랑을 표현하고 받고 싶어하는 방식을 분析합니다.", h1:"MBTI 사랑의 언어 — 유형별 사랑 표현 방식", sub:"MBTI 유형별 사랑의 언어와 표현 방식 분析", emoji:"💕" },
  { slug:"mbti-study-style", title:"MBTI 공부 스타일 | 점운 MBTI", desc:"MBTI 유형별 공부 스타일 — 각 유형에 맞는 효율적인 공부법과 학습 환경을 분析합니다.", h1:"MBTI 공부 스타일 — 유형별 효율적 학습법", sub:"MBTI 유형별 공부 스타일과 최적 학습 환경 분析", emoji:"📚" },
  { slug:"mbti-friendship", title:"MBTI 우정 스타일 | 점운 MBTI", desc:"MBTI 유형별 우정 스타일 — 각 유형이 친구와 관계를 맺고 유지하는 방식을 분析합니다.", h1:"MBTI 우정 스타일 — 유형별 친구 관계 방식", sub:"MBTI 유형별 우정 스타일과 친구 관계 패턴 분析", emoji:"👫" },
  { slug:"mbti-anger-pattern", title:"MBTI 화남 패턴 | 점운 MBTI", desc:"MBTI 유형별 화남 패턴 — 각 유형이 화가 났을 때 보이는 반응과 해소 방법을 분析합니다.", h1:"MBTI 화남 패턴 — 유형별 분노 표현 방식", sub:"MBTI 유형별 화남 패턴과 분노 해소 방법 분析", emoji:"😤" },
  { slug:"mbti-sleep-pattern", title:"MBTI 수면 패턴 | 점운 MBTI", desc:"MBTI 유형별 수면 패턴 — 각 유형에 맞는 수면 시간과 취침 전 루틴을 분析합니다.", h1:"MBTI 수면 패턴 — 유형별 최적 수면 방식", sub:"MBTI 유형별 수면 패턴과 최적 취침 루틴 분析", emoji:"😴" },
  { slug:"mbti-travel-style", title:"MBTI 여행 스타일 | 점운 MBTI", desc:"MBTI 유형별 여행 스타일 — 각 유형에 맞는 여행지와 여행 방식을 분析합니다.", h1:"MBTI 여행 스타일 — 유형별 최적 여행 방식", sub:"MBTI 유형별 여행 스타일과 최적 여행지 분析", emoji:"✈️" },
  { slug:"mbti-diet-style", title:"MBTI 다이어트 스타일 | 점운 MBTI", desc:"MBTI 유형별 다이어트 스타일 — 각 유형에 맞는 다이어트 방법과 지속 전략을 분析합니다.", h1:"MBTI 다이어트 스타일 — 유형별 효과적 다이어트", sub:"MBTI 유형별 다이어트 스타일과 성공 전략 분析", emoji:"🥗" },
  { slug:"intj-compatibility", title:"INTJ 궁합 | 점운 MBTI", desc:"INTJ 궁합 — 전략가 INTJ와 잘 맞는 유형과 맞지 않는 유형, 최고의 파트너를 분析합니다.", h1:"INTJ 궁합 — 전략가와 잘 맞는 MBTI 유형", sub:"INTJ 전략가와 최고의 궁합 MBTI 유형 분析", emoji:"💑" },
  { slug:"infp-compatibility", title:"INFP 궁합 | 점운 MBTI", desc:"INFP 궁합 — 중재자 INFP와 잘 맞는 유형과 맞지 않는 유형, 최고의 파트너를 분析합니다.", h1:"INFP 궁합 — 중재자와 잘 맞는 MBTI 유형", sub:"INFP 중재자와 최고의 궁합 MBTI 유형 분析", emoji:"💜" },
  { slug:"enfp-compatibility", title:"ENFP 궁합 | 점운 MBTI", desc:"ENFP 궁합 — 활동가 ENFP와 잘 맞는 유형과 맞지 않는 유형, 최고의 파트너를 분析합니다.", h1:"ENFP 궁합 — 활동가와 잘 맞는 MBTI 유형", sub:"ENFP 활동가와 최고의 궁합 MBTI 유형 분析", emoji:"💛" },
  { slug:"entj-compatibility", title:"ENTJ 궁합 | 점운 MBTI", desc:"ENTJ 궁합 — 통솔자 ENTJ와 잘 맞는 유형과 맞지 않는 유형, 최고의 파트너를 분析합니다.", h1:"ENTJ 궁합 — 통솔자와 잘 맞는 MBTI 유형", sub:"ENTJ 통솔자와 최고의 궁합 MBTI 유형 분析", emoji:"👑" },
  { slug:"intp-compatibility", title:"INTP 궁합 | 점운 MBTI", desc:"INTP 궁합 — 논리학자 INTP와 잘 맞는 유형과 맞지 않는 유형, 최고의 파트너를 분析합니다.", h1:"INTP 궁합 — 논리학자와 잘 맞는 MBTI 유형", sub:"INTP 논리학자와 최고의 궁합 MBTI 유형 분析", emoji:"🔬" },
  { slug:"isfj-compatibility", title:"ISFJ 궁합 | 점운 MBTI", desc:"ISFJ 궁합 — 수호자 ISFJ와 잘 맞는 유형과 맞지 않는 유형, 최고의 파트너를 분析합니다.", h1:"ISFJ 궁합 — 수호자와 잘 맞는 MBTI 유형", sub:"ISFJ 수호자와 최고의 궁합 MBTI 유형 분析", emoji:"🛡️" },
  { slug:"mbti-zodiac-aries", title:"양자리 MBTI 유형 | 점운 MBTI", desc:"양자리와 MBTI 유형의 관계 — 양자리(3/21~4/19)에 많은 MBTI 유형과 성격 특성을 분析합니다.", h1:"양자리 MBTI — 양자리에 많은 MBTI 유형", sub:"양자리 별자리와 MBTI 유형 연결 분析", emoji:"♈" },
  { slug:"mbti-zodiac-scorpio", title:"전갈자리 MBTI 유형 | 점운 MBTI", desc:"전갈자리와 MBTI 유형의 관계 — 전갈자리(10/24~11/21)에 많은 MBTI 유형과 성격 특성을 분析합니다.", h1:"전갈자리 MBTI — 전갈자리에 많은 MBTI 유형", sub:"전갈자리 별자리와 MBTI 유형 연결 분析", emoji:"♏" },
  { slug:"mbti-zodiac-aquarius", title:"물병자리 MBTI 유형 | 점운 MBTI", desc:"물병자리와 MBTI 유형의 관계 — 물병자리(1/20~2/18)에 많은 MBTI 유형과 성격 특성을 분析합니다.", h1:"물병자리 MBTI — 물병자리에 많은 MBTI 유형", sub:"물병자리 별자리와 MBTI 유형 연결 분析", emoji:"♒" },
  { slug:"mbti-zodiac-leo", title:"사자자리 MBTI 유형 | 점운 MBTI", desc:"사자자리와 MBTI 유형의 관계 — 사자자리(7/23~8/22)에 많은 MBTI 유형과 성격 특성을 분析합니다.", h1:"사자자리 MBTI — 사자자리에 많은 MBTI 유형", sub:"사자자리 별자리와 MBTI 유형 연결 분析", emoji:"♌" },
  { slug:"mbti-blood-type-a", title:"A형 MBTI 유형 | 점운 MBTI", desc:"혈액형 A형과 MBTI 유형의 관계 — A형에 많은 MBTI 유형과 성격 특성을 분析합니다.", h1:"A형 MBTI — A형 혈액형과 잘 맞는 MBTI", sub:"혈액형 A형에 많은 MBTI 유형 분析", emoji:"🅰️" },
  { slug:"mbti-blood-type-b", title:"B형 MBTI 유형 | 점운 MBTI", desc:"혈액형 B형과 MBTI 유형의 관계 — B형에 많은 MBTI 유형과 성격 특성을 분析합니다.", h1:"B형 MBTI — B형 혈액형과 잘 맞는 MBTI", sub:"혈액형 B형에 많은 MBTI 유형 분析", emoji:"🅱️" },
  { slug:"mbti-blood-type-o", title:"O형 MBTI 유형 | 점운 MBTI", desc:"혈액형 O형과 MBTI 유형의 관계 — O형에 많은 MBTI 유형과 성격 특성을 분析합니다.", h1:"O형 MBTI — O형 혈액형과 잘 맞는 MBTI", sub:"혈액형 O형에 많은 MBTI 유형 분析", emoji:"⭕" },
  { slug:"mbti-blood-type-ab", title:"AB형 MBTI 유형 | 점운 MBTI", desc:"혈액형 AB형과 MBTI 유형의 관계 — AB형에 많은 MBTI 유형과 성격 특성을 분析합니다.", h1:"AB형 MBTI — AB형 혈액형과 잘 맞는 MBTI", sub:"혈액형 AB형에 많은 MBTI 유형 분析", emoji:"🔠" },
  { slug:"mbti-introvert-extrovert", title:"내향형 외향형 MBTI 차이 | 점운 MBTI", desc:"MBTI 내향형(I)과 외향형(E)의 실질적 차이 — 에너지 충전 방식과 일상 행동 패턴을 분析합니다.", h1:"내향형 외향형 차이 — I형 E형 실질적 차이", sub:"MBTI 내향형 외향형의 실질적 차이와 특성 분析", emoji:"🔄" },
  { slug:"mbti-thinking-feeling", title:"사고형 감정형 MBTI 차이 | 점운 MBTI", desc:"MBTI 사고형(T)과 감정형(F)의 실질적 차이 — 의사결정 방식과 대인관계 패턴을 분析합니다.", h1:"사고형 감정형 차이 — T형 F형 실질적 차이", sub:"MBTI 사고형 감정형의 실질적 차이와 특성 분析", emoji:"🧠" },
  { slug:"mbti-sensing-intuition", title:"감각형 직관형 MBTI 차이 | 점운 MBTI", desc:"MBTI 감각형(S)과 직관형(N)의 실질적 차이 — 정보 처리 방식과 관점의 차이를 분析합니다.", h1:"감각형 직관형 차이 — S형 N형 실질적 차이", sub:"MBTI 감각형 직관형의 실질적 차이와 특성 분析", emoji:"👁️" },
  { slug:"mbti-judging-perceiving", title:"판단형 인식형 MBTI 차이 | 점운 MBTI", desc:"MBTI 판단형(J)과 인식형(P)의 실질적 차이 — 생활 방식과 계획성의 차이를 분析합니다.", h1:"판단형 인식형 차이 — J형 P형 실질적 차이", sub:"MBTI 판단형 인식형의 실질적 차이와 특성 분析", emoji:"⚖️" },
  { slug:"mbti-famous-person-intj", title:"INTJ 유명인 | 점운 MBTI", desc:"INTJ 유형의 유명인 — 전략가 INTJ 유형으로 알려진 국내외 유명인과 그 특성을 분析합니다.", h1:"INTJ 유명인 — 전략가 유형 유명인 분析", sub:"INTJ 전략가 유형 유명인과 공통 특성 분析", emoji:"🌟" },
  { slug:"mbti-famous-person-infp", title:"INFP 유명인 | 점운 MBTI", desc:"INFP 유형의 유명인 — 중재자 INFP 유형으로 알려진 국내외 유명인과 그 특성을 분析합니다.", h1:"INFP 유명인 — 중재자 유형 유명인 분析", sub:"INFP 중재자 유형 유명인과 공통 특성 분析", emoji:"🌟" },
  { slug:"mbti-famous-person-enfp", title:"ENFP 유명인 | 점운 MBTI", desc:"ENFP 유형의 유명인 — 활동가 ENFP 유형으로 알려진 국내외 유명인과 그 특성을 분析합니다.", h1:"ENFP 유명인 — 활동가 유형 유명인 분析", sub:"ENFP 활동가 유형 유명인과 공통 특성 분析", emoji:"🌟" },
  { slug:"mbti-famous-person-entj", title:"ENTJ 유명인 | 점운 MBTI", desc:"ENTJ 유형의 유명인 — 통솔자 ENTJ 유형으로 알려진 국내외 유명인과 그 특성을 분析합니다.", h1:"ENTJ 유명인 — 통솔자 유형 유명인 분析", sub:"ENTJ 통솔자 유형 유명인과 공통 특성 분析", emoji:"🌟" },
  { slug:"mbti-misconception", title:"MBTI 오해와 진실 | 점운 MBTI", desc:"MBTI에 대한 오해와 진실 — MBTI 검사의 한계와 올바른 활용 방법을 설명합니다.", h1:"MBTI 오해와 진실 — MBTI 바르게 이해하기", sub:"MBTI 검사의 한계와 올바른 활용 방법 설명", emoji:"🔍" },
  { slug:"mbti-accuracy", title:"MBTI 정확도 | 점운 MBTI", desc:"MBTI 정확도 — MBTI 검사 결과가 얼마나 정확한지, 신뢰성과 타당성을 분析합니다.", h1:"MBTI 정확도 — MBTI 검사 결과 신뢰도", sub:"MBTI 검사 정확도와 신뢰성 타당성 분析", emoji:"📊" },
  { slug:"mbti-change", title:"MBTI 변화 가능성 | 점운 MBTI", desc:"MBTI 유형이 변할 수 있나요? — 나이와 경험에 따른 MBTI 유형 변화 가능성을 분析합니다.", h1:"MBTI 변화 가능성 — MBTI 유형 변화 분析", sub:"나이와 경험에 따른 MBTI 유형 변화 가능성 분析", emoji:"🔄" },
  { slug:"mbti-ohang-connection", title:"MBTI와 오행 연결 | 점운 MBTI", desc:"MBTI와 사주 오행의 연결 — MBTI 유형과 사주 오행 기질이 어떻게 연결되는지 분析합니다.", h1:"MBTI와 오행 연결 — MBTI × 사주 오행 분析", sub:"MBTI 유형과 사주 오행 기질 연결 분析", emoji:"☯️" },
  { slug:"mbti-best-job", title:"MBTI별 최고 직업 | 점운 MBTI", desc:"MBTI 유형별 최고 직업 — 16가지 MBTI 유형마다 가장 잘 맞는 직업과 커리어를 분析합니다.", h1:"MBTI별 최고 직업 — 유형별 최적 커리어", sub:"MBTI 16유형별 가장 잘 맞는 직업과 커리어 분析", emoji:"💼" },
  { slug:"mbti-worst-job", title:"MBTI별 피해야 할 직업 | 점운 MBTI", desc:"MBTI 유형별 피해야 할 직업 — 각 유형에 스트레스를 주는 직업과 피해야 할 환경을 분析합니다.", h1:"MBTI별 피해야 할 직업 — 유형별 비추 직업", sub:"MBTI 유형별 피해야 할 직업과 환경 분析", emoji:"🚫" },
  { slug:"mbti-leadership", title:"MBTI 리더십 스타일 | 점운 MBTI", desc:"MBTI 유형별 리더십 스타일 — 각 유형이 리더가 됐을 때 보이는 행동 패턴과 강점을 분析합니다.", h1:"MBTI 리더십 스타일 — 유형별 리더 패턴", sub:"MBTI 유형별 리더십 스타일과 강점 분析", emoji:"👑" },
  { slug:"mbti-conflict-style", title:"MBTI 갈등 해결 스타일 | 점운 MBTI", desc:"MBTI 유형별 갈등 해결 스타일 — 각 유형이 갈등 상황에서 보이는 반응과 해결 방식을 분析합니다.", h1:"MBTI 갈등 해결 — 유형별 갈등 대처 방식", sub:"MBTI 유형별 갈등 해결 스타일과 대처 방식 분析", emoji:"🤝" },
  { slug:"mbti-social-skill", title:"MBTI 사회성 | 점운 MBTI", desc:"MBTI 유형별 사회성 — 각 유형이 사람들과 어울리는 방식과 사회적 상황에서의 특성을 분析합니다.", h1:"MBTI 사회성 — 유형별 사람 관계 방식", sub:"MBTI 유형별 사회성과 사람 관계 패턴 분析", emoji:"👥" },
  { slug:"enfp-intj-couple", title:"ENFP INTJ 커플 | 점운 MBTI", desc:"ENFP와 INTJ 커플 궁합 — 반대 유형의 끌림과 장기 관계에서의 조화 방법을 분析합니다.", h1:"ENFP INTJ 커플 — 반대 유형의 끌림과 조화", sub:"ENFP와 INTJ 커플 궁합과 장기 관계 분析", emoji:"💑" },
  { slug:"infp-enfj-couple", title:"INFP ENFJ 커플 | 점운 MBTI", desc:"INFP와 ENFJ 커플 궁합 — 이상적인 파트너십을 이루는 두 유형의 관계 분析.", h1:"INFP ENFJ 커플 — 이상적 파트너십 분析", sub:"INFP와 ENFJ 커플 궁합과 이상적 관계 분析", emoji:"💕" },
  { slug:"intj-infj-couple", title:"INTJ INFJ 커플 | 점운 MBTI", desc:"INTJ와 INFJ 커플 궁합 — 내향적 직관형 두 유형이 만났을 때의 관계와 조화를 분析합니다.", h1:"INTJ INFJ 커플 — 내향 직관형 커플 분析", sub:"INTJ와 INFJ 커플 궁합과 내향형 관계 분析", emoji:"🌙" },
  { slug:"mbti-workplace-intj", title:"INTJ 직장 동료 | 점운 MBTI", desc:"INTJ 직장 동료 다루는 법 — INTJ 유형 동료와 효과적으로 일하는 방법과 소통 팁.", h1:"INTJ 직장 동료 — INTJ와 효과적으로 일하는 법", sub:"INTJ 직장 동료 이해하기와 효과적 소통 방법", emoji:"💼" },
  { slug:"mbti-workplace-infp", title:"INFP 직장 동료 | 점운 MBTI", desc:"INFP 직장 동료 다루는 법 — INFP 유형 동료와 효과적으로 일하는 방법과 소통 팁.", h1:"INFP 직장 동료 — INFP와 효과적으로 일하는 법", sub:"INFP 직장 동료 이해하기와 효과적 소통 방법", emoji:"🎨" },
  { slug:"mbti-growth-intj", title:"INTJ 성장 방향 | 점운 MBTI", desc:"INTJ 성장 방향 — 완벽주의 전략가 INTJ가 더 성장하기 위해 발전시켜야 할 영역과 방향.", h1:"INTJ 성장 방향 — 전략가의 개인 성장 로드맵", sub:"INTJ 전략가 유형의 성장 방향과 발전 영역 분析", emoji:"🌱" },
  { slug:"mbti-growth-infp", title:"INFP 성장 방향 | 점운 MBTI", desc:"INFP 성장 방향 — 이상주의 중재자 INFP가 더 성장하기 위해 발전시켜야 할 영역과 방향.", h1:"INFP 성장 방향 — 중재자의 개인 성장 로드맵", sub:"INFP 중재자 유형의 성장 방향과 발전 영역 분析", emoji:"🌸" },
  { slug:"mbti-growth-enfp", title:"ENFP 성장 방향 | 점운 MBTI", desc:"ENFP 성장 방향 — 열정적 활동가 ENFP가 더 성장하기 위해 발전시켜야 할 영역과 방향.", h1:"ENFP 성장 방향 — 활동가의 개인 성장 로드맵", sub:"ENFP 활동가 유형의 성장 방향과 발전 영역 분析", emoji:"🌈" },
  { slug:"mbti-free-test", title:"MBTI 무료 테스트 | 점운 MBTI", desc:"MBTI 무료 테스트 — 정확하고 무료인 MBTI 성격 유형 검사를 받아보세요.", h1:"MBTI 무료 테스트 — 무료 성격 유형 검사", sub:"정확하고 무료인 MBTI 성격 유형 검사 안내", emoji:"📋" },
  { slug:"mbti-test-accuracy", title:"MBTI 테스트 정확도 | 점운 MBTI", desc:"MBTI 테스트 정확도 — MBTI 테스트가 얼마나 정확한지 과학적 근거로 설명합니다.", h1:"MBTI 테스트 정확도 — 과학적 신뢰도 분析", sub:"MBTI 테스트 정확도와 과학적 근거 분析", emoji:"🔬" },
  { slug:"mbti-16-types-summary", title:"MBTI 16가지 유형 요약 | 점운 MBTI", desc:"MBTI 16가지 유형 한눈에 요약 — INTJ부터 ESFP까지 16가지 유형의 핵심 특성을 정리합니다.", h1:"MBTI 16유형 요약 — 16가지 유형 한눈에 보기", sub:"MBTI 16가지 유형 핵심 특성 한눈에 요약", emoji:"📊" },
  { slug:"mbti-most-common", title:"가장 흔한 MBTI 유형 | 점운 MBTI", desc:"가장 흔한 MBTI 유형 — 세계에서 가장 많은 유형과 한국에서 가장 많은 MBTI 유형을 분析합니다.", h1:"가장 흔한 MBTI — 세계 및 한국 최다 MBTI 유형", sub:"세계와 한국에서 가장 흔한 MBTI 유형 분析", emoji:"📈" },
  { slug:"mbti-rarest", title:"가장 희귀한 MBTI 유형 | 점운 MBTI", desc:"가장 희귀한 MBTI 유형 — 세계에서 가장 드문 MBTI 유형과 그 특성을 분析합니다.", h1:"가장 희귀한 MBTI — 세계 최희귀 MBTI 유형", sub:"세계에서 가장 희귀한 MBTI 유형과 특성 분析", emoji:"💎" },
  { slug:"mbti-and-saju", title:"MBTI와 사주 연결 | 점운 MBTI", desc:"MBTI와 사주 연결 — 서양 심리 유형론 MBTI와 동양 사주 오행이 어떻게 연결되는지 분析합니다.", h1:"MBTI와 사주 연결 — 동서양 성격 분析 연결", sub:"MBTI 서양 심리학과 사주 동양 오행의 연결 분析", emoji:"☯️" },
  { slug:"mbti-for-couples", title:"커플 MBTI 궁합 | 점운 MBTI", desc:"커플 MBTI 궁합 — 연인 사이의 MBTI 유형 궁합과 관계 개선 방법을 분析합니다.", h1:"커플 MBTI 궁합 — 연인 MBTI 궁합 완전 분析", sub:"커플 MBTI 유형 궁합과 관계 개선 방법 분析", emoji:"💑" },
  { slug:"mbti-for-friends", title:"친구 MBTI 궁합 | 점운 MBTI", desc:"친구 MBTI 궁합 — 친구와의 MBTI 유형 궁합과 우정 강화 방법을 분析합니다.", h1:"친구 MBTI 궁합 — 친구 MBTI 궁합 완전 분析", sub:"친구 MBTI 유형 궁합과 우정 강화 방법 분析", emoji:"👫" },
  { slug:"mbti-for-work", title:"직장 MBTI 궁합 | 점운 MBTI", desc:"직장 MBTI 궁합 — 직장 동료와의 MBTI 유형 궁합과 협업 방법을 분析합니다.", h1:"직장 MBTI 궁합 — 직장 동료 MBTI 궁합 분析", sub:"직장 동료 MBTI 유형 궁합과 협업 방법 분析", emoji:"💼" },
  { slug:"mbti-for-family", title:"가족 MBTI 궁합 | 점운 MBTI", desc:"가족 MBTI 궁합 — 부모·형제·자녀와의 MBTI 유형 궁합과 가족 관계 개선 방법을 분析합니다.", h1:"가족 MBTI 궁합 — 가족 MBTI 궁합 완전 분析", sub:"가족 MBTI 유형 궁합과 관계 개선 방법 분析", emoji:"👨‍👩‍👧" },
  { slug:"mbti-parenting", title:"MBTI 유형별 육아 스타일 | 점운 MBTI", desc:"MBTI 유형별 육아 스타일 — 각 유형 부모가 아이를 키우는 방식과 강점·약점을 분析합니다.", h1:"MBTI 육아 스타일 — 유형별 부모 육아 방식", sub:"MBTI 유형별 육아 스타일과 부모 강점 분析", emoji:"👶" },
  { slug:"mbti-money-habit", title:"MBTI 돈 관리 습관 | 점운 MBTI", desc:"MBTI 유형별 돈 관리 습관 — 각 유형이 돈을 어떻게 관리하고 소비하는지 분析합니다.", h1:"MBTI 돈 관리 — 유형별 재물 관리 습관", sub:"MBTI 유형별 돈 관리 습관과 소비 패턴 분析", emoji:"💰" },
  { slug:"mbti-health-habit", title:"MBTI 건강 관리 습관 | 점운 MBTI", desc:"MBTI 유형별 건강 관리 습관 — 각 유형이 건강을 관리하는 방식과 취약한 건강 문제를 분析합니다.", h1:"MBTI 건강 관리 — 유형별 건강 관리 습관", sub:"MBTI 유형별 건강 관리 습관과 취약 건강 문제 분析", emoji:"💪" },
  { slug:"mbti-communication-style", title:"MBTI 소통 스타일 | 점운 MBTI", desc:"MBTI 유형별 소통 스타일 — 각 유형이 다른 사람과 소통하는 방식과 효과적 소통법을 분析합니다.", h1:"MBTI 소통 스타일 — 유형별 소통 방식 분析", sub:"MBTI 유형별 소통 스타일과 효과적 소통법 분析", emoji:"💬" },
  { slug:"mbti-overthinking", title:"MBTI 오버씽킹 유형 | 점운 MBTI", desc:"MBTI 유형별 오버씽킹 — 생각이 너무 많아 힘든 MBTI 유형과 해결 방법을 분析합니다.", h1:"MBTI 오버씽킹 — 생각 많은 MBTI 유형 분析", sub:"MBTI 유형별 오버씽킹 패턴과 해결 방법 분析", emoji:"🤔" },
  { slug:"mbti-dark-side", title:"MBTI 유형별 단점 | 점운 MBTI", desc:"MBTI 유형별 단점 — 각 MBTI 유형이 가진 약점과 성장을 위해 극복해야 할 단점을 분析합니다.", h1:"MBTI 유형별 단점 — 각 유형의 약점과 극복법", sub:"MBTI 16유형별 단점과 약점 극복 방법 분析", emoji:"⚠️" },
  { slug:"mbti-when-upset", title:"MBTI 기분 나쁠 때 | 점운 MBTI", desc:"MBTI 유형별 기분 나쁠 때 행동 — 각 유형이 기분이 상했을 때 보이는 반응 패턴을 분析합니다.", h1:"MBTI 기분 나쁠 때 — 유형별 반응 패턴 분析", sub:"MBTI 유형별 기분 나쁠 때 행동 패턴 분析", emoji:"😤" },
  { slug:"mbti-ideal-partner-type", title:"MBTI 이상형 유형 | 점운 MBTI", desc:"MBTI 유형별 이상형 — 각 MBTI 유형이 꿈꾸는 이상적인 파트너 유형과 특성을 분析합니다.", h1:"MBTI 이상형 — 유형별 이상적 파트너 분析", sub:"MBTI 유형별 이상형 파트너 특성 분析", emoji:"💫" },
  { slug:"mbti-in-korea", title:"한국인 MBTI 특성 | 점운 MBTI", desc:"한국인 MBTI 특성 — 한국인에게 많은 MBTI 유형과 한국 문화와 MBTI의 연관성을 분析합니다.", h1:"한국인 MBTI — 한국인에게 많은 MBTI 유형", sub:"한국인에게 많은 MBTI 유형과 문화 연관성 분析", emoji:"🇰🇷" },
  { slug:"mbti-at-school", title:"학교에서의 MBTI | 점운 MBTI", desc:"학교에서의 MBTI 유형 — 각 유형이 학교 생활에서 보이는 특성과 학습 스타일을 분析합니다.", h1:"학교에서의 MBTI — 유형별 학교 생활 분析", sub:"MBTI 유형별 학교 생활 특성과 학습 스타일 분析", emoji:"🏫" },
  { slug:"mbti-at-party", title:"파티에서의 MBTI | 점운 MBTI", desc:"파티에서의 MBTI 유형 — 각 유형이 파티나 모임에서 보이는 행동 패턴과 특성을 분析합니다.", h1:"파티에서의 MBTI — 유형별 모임 행동 분析", sub:"MBTI 유형별 파티 모임에서의 행동 패턴 분析", emoji:"🎉" },
  { slug:"mbti-when-in-love", title:"MBTI 사랑에 빠졌을 때 | 점운 MBTI", desc:"MBTI 유형별 사랑에 빠졌을 때 — 각 유형이 좋아하는 사람 앞에서 보이는 행동 패턴을 분析합니다.", h1:"MBTI 사랑에 빠졌을 때 — 유형별 연애 초기 행동", sub:"MBTI 유형별 사랑에 빠졌을 때 행동 패턴 분析", emoji:"💘" },
  { slug:"mbti-breakup-style", title:"MBTI 이별 스타일 | 점운 MBTI", desc:"MBTI 유형별 이별 스타일 — 각 유형이 이별 상황에서 보이는 반응과 회복 방법을 분析합니다.", h1:"MBTI 이별 스타일 — 유형별 이별 반응과 회복", sub:"MBTI 유형별 이별 스타일과 회복 방법 분析", emoji:"💔" },
  { slug:"mbti-gift-preference", title:"MBTI 선물 취향 | 점운 MBTI", desc:"MBTI 유형별 선물 취향 — 각 유형이 가장 좋아하는 선물 유형과 선물 방식을 분析합니다.", h1:"MBTI 선물 취향 — 유형별 선호 선물 분析", sub:"MBTI 유형별 선물 취향과 선물 아이디어 분析", emoji:"🎁" },
  { slug:"mbti-music-taste", title:"MBTI 음악 취향 | 점운 MBTI", desc:"MBTI 유형별 음악 취향 — 각 유형이 좋아하는 음악 장르와 음악과의 관계를 분析합니다.", h1:"MBTI 음악 취향 — 유형별 선호 음악 장르 분析", sub:"MBTI 유형별 음악 취향과 선호 장르 분析", emoji:"🎵" },
  { slug:"mbti-movie-taste", title:"MBTI 영화 취향 | 점운 MBTI", desc:"MBTI 유형별 영화 취향 — 각 유형이 좋아하는 영화 장르와 영화 관람 방식을 분析합니다.", h1:"MBTI 영화 취향 — 유형별 선호 영화 장르 분析", sub:"MBTI 유형별 영화 취향과 선호 장르 분析", emoji:"🎬" },
  { slug:"mbti-food-preference", title:"MBTI 음식 취향 | 점운 MBTI", desc:"MBTI 유형별 음식 취향 — 각 유형이 좋아하는 음식 유형과 식사 방식을 분析합니다.", h1:"MBTI 음식 취향 — 유형별 선호 음식 분析", sub:"MBTI 유형별 음식 취향과 선호 음식 분析", emoji:"🍽️" },
  { slug:"mbti-exercise-style", title:"MBTI 운동 스타일 | 점운 MBTI", desc:"MBTI 유형별 운동 스타일 — 각 유형에 맞는 운동 종류와 지속하는 방법을 분析합니다.", h1:"MBTI 운동 스타일 — 유형별 적합한 운동 분析", sub:"MBTI 유형별 운동 스타일과 적합한 운동 분析", emoji:"🏃" },
  { slug:"mbti-ideal-home", title:"MBTI 이상적 집 | 점운 MBTI", desc:"MBTI 유형별 이상적 집 — 각 유형에게 가장 잘 맞는 주거 환경과 인테리어 스타일을 분析합니다.", h1:"MBTI 이상적 집 — 유형별 주거 환경 분析", sub:"MBTI 유형별 이상적 주거 환경과 인테리어 분析", emoji:"🏠" },
  { slug:"mbti-vacation-type", title:"MBTI 휴가 스타일 | 점운 MBTI", desc:"MBTI 유형별 휴가 스타일 — 각 유형에게 가장 완벽한 휴가 방식과 여행지 유형을 분析합니다.", h1:"MBTI 휴가 스타일 — 유형별 완벽한 휴가 방식", sub:"MBTI 유형별 휴가 스타일과 완벽한 여행지 분析", emoji:"🏖️" },
  { slug:"mbti-introvert-guide", title:"내향형 MBTI 가이드 | 점운 MBTI", desc:"내향형 MBTI(I) 완전 가이드 — INTJ·INFJ·INTJ·INFP·ISTJ·ISFJ·ISTP·ISFP의 특성과 강점.", h1:"내향형 MBTI 가이드 — I형 완전 분析", sub:"내향형 MBTI 8유형 특성·강점·약점 완전 분析", emoji:"🌙" },
  { slug:"mbti-extrovert-guide", title:"외향형 MBTI 가이드 | 점운 MBTI", desc:"외향형 MBTI(E) 완전 가이드 — ENTJ·ENFJ·ENTP·ENFP·ESTJ·ESFJ·ESTP·ESFP의 특성과 강점.", h1:"외향형 MBTI 가이드 — E형 완전 분析", sub:"외향형 MBTI 8유형 특성·강점·약점 완전 분析", emoji:"☀️" },
  { slug:"mbti-work-from-home", title:"MBTI 재택근무 스타일 | 점운 MBTI", desc:"MBTI별 재택근무 스타일 — 내 MBTI 유형이 재택근무에서 어떻게 적응하고 생산성을 높이는지 확인하세요.", h1:"MBTI 재택근무 스타일 — 유형별 재택 생산성", sub:"MBTI 유형별 재택근무 적응 방법과 생산성 가이드", emoji:"🏠" },
  { slug:"mbti-morning-person", title:"아침형 MBTI 유형 | 점운 MBTI", desc:"아침형 인간 MBTI — 어떤 MBTI 유형이 아침에 가장 활발하고 생산적인지 확인하세요.", h1:"아침형 MBTI 유형 — 아침 에너지 높은 유형", sub:"아침 에너지가 높은 MBTI 유형과 루틴 가이드", emoji:"🌅" },
  { slug:"mbti-night-person", title:"저녁형 MBTI 유형 | 점운 MBTI", desc:"저녁형 인간 MBTI — 어떤 MBTI 유형이 밤에 가장 창의적이고 집중력이 높아지는지 확인하세요.", h1:"저녁형 MBTI 유형 — 밤 에너지 높은 유형", sub:"밤 에너지가 높은 MBTI 유형과 야간 루틴 가이드", emoji:"🌙" },
  { slug:"mbti-introvert-recharge", title:"내향형 에너지 충전법 | 점운 MBTI", desc:"내향형 MBTI 에너지 충전법 — I형 MBTI가 번아웃 없이 에너지를 회복하는 최적의 방법을 안내합니다.", h1:"내향형 에너지 충전법 — I형 MBTI 회복 방법", sub:"내향형 MBTI I형의 에너지 회복과 충전 방법 가이드", emoji:"🔋" },
  { slug:"mbti-extrovert-energy", title:"외향형 에너지 관리 | 점운 MBTI", desc:"외향형 MBTI 에너지 관리 — E형 MBTI가 사회 활동으로 에너지를 채우고 지치지 않는 방법을 안내합니다.", h1:"외향형 에너지 관리 — E형 MBTI 활력 유지", sub:"외향형 MBTI E형의 에너지 관리와 활력 유지 가이드", emoji:"⚡" },
  { slug:"mbti-arguing-style", title:"MBTI 싸우는 방식 | 점운 MBTI", desc:"MBTI별 싸우는 방식 — 각 MBTI 유형이 갈등과 논쟁에서 어떻게 반응하고 싸우는지 분析합니다.", h1:"MBTI 싸우는 방식 — 유형별 갈등 패턴", sub:"MBTI 유형별 싸우는 방식과 갈등 해결 패턴 분析", emoji:"🥊" },
  { slug:"mbti-apologize-style", title:"MBTI 사과하는 방식 | 점운 MBTI", desc:"MBTI별 사과하는 방식 — 각 MBTI 유형이 갈등 후 어떻게 사과하고 화해를 구하는지 분析합니다.", h1:"MBTI 사과하는 방식 — 유형별 화해 패턴", sub:"MBTI 유형별 사과 방식과 화해 패턴 완전 분析", emoji:"🙏" },
  { slug:"mbti-text-style", title:"MBTI 문자 스타일 | 점운 MBTI", desc:"MBTI별 문자 스타일 — 각 MBTI 유형이 문자와 채팅에서 어떻게 소통하는지 분析합니다.", h1:"MBTI 문자 스타일 — 유형별 채팅 소통 패턴", sub:"MBTI 유형별 문자·채팅 소통 방식 완전 분析", emoji:"💬" },
  { slug:"mbti-humor-style", title:"MBTI 유머 스타일 | 점운 MBTI", desc:"MBTI별 유머 스타일 — 각 MBTI 유형이 어떤 종류의 유머를 즐기고 어떻게 웃기는지 분析합니다.", h1:"MBTI 유머 스타일 — 유형별 웃음 코드", sub:"MBTI 유형별 유머 감각과 웃음 코드 완전 분析", emoji:"😂" },
  { slug:"mbti-decision-making", title:"MBTI 의사결정 방식 | 점운 MBTI", desc:"MBTI별 의사결정 방식 — 각 MBTI 유형이 중요한 결정을 내릴 때 어떻게 생각하고 선택하는지 분析합니다.", h1:"MBTI 의사결정 방식 — 유형별 결정 패턴", sub:"MBTI 유형별 의사결정 방식과 선택 패턴 분析", emoji:"🤔" },
  { slug:"mbti-goal-setting", title:"MBTI 목표 설정 방식 | 점운 MBTI", desc:"MBTI별 목표 설정 방식 — 각 MBTI 유형이 어떻게 목표를 세우고 달성해나가는지 분析합니다.", h1:"MBTI 목표 설정 방식 — 유형별 목표 달성 패턴", sub:"MBTI 유형별 목표 설정과 달성 방식 완전 분析", emoji:"🎯" },
  { slug:"mbti-procrastination", title:"MBTI 미루기 패턴 | 점운 MBTI", desc:"MBTI별 미루기 패턴 — 각 MBTI 유형이 어떻게 미루기를 하고 어떻게 극복하는지 분析합니다.", h1:"MBTI 미루기 패턴 — 유형별 게으름 극복법", sub:"MBTI 유형별 미루기 패턴과 극복 방법 분析", emoji:"⏳" },
  { slug:"mbti-creative-process", title:"MBTI 창작 과정 | 점운 MBTI", desc:"MBTI별 창작 과정 — 각 MBTI 유형이 창의적 작업을 어떻게 접근하고 완성하는지 분析합니다.", h1:"MBTI 창작 과정 — 유형별 창의성 발현 방법", sub:"MBTI 유형별 창작 과정과 창의성 발현 방법 분析", emoji:"🎨" },
  { slug:"mbti-reading-taste", title:"MBTI 독서 취향 | 점운 MBTI", desc:"MBTI별 독서 취향 — 각 MBTI 유형이 어떤 장르의 책을 좋아하고 어떻게 읽는지 분析합니다.", h1:"MBTI 독서 취향 — 유형별 책 장르 선호도", sub:"MBTI 유형별 독서 취향과 좋아하는 책 장르 分析", emoji:"📚" },
  { slug:"mbti-pet-preference", title:"MBTI 반려동물 취향 | 점운 MBTI", desc:"MBTI별 반려동물 취향 — 각 MBTI 유형에게 어떤 반려동물이 가장 잘 어울리는지 분析합니다.", h1:"MBTI 반려동물 취향 — 유형별 최적 반려동물", sub:"MBTI 유형별 어울리는 반려동물과 취향 분析", emoji:"🐾" },
  { slug:"mbti-fashion-style", title:"MBTI 패션 스타일 | 점운 MBTI", desc:"MBTI별 패션 스타일 — 각 MBTI 유형이 어떤 옷을 좋아하고 어떻게 스타일링하는지 분析합니다.", h1:"MBTI 패션 스타일 — 유형별 옷차림 취향", sub:"MBTI 유형별 패션 스타일과 옷차림 취향 완전 분析", emoji:"👗" },
  { slug:"mbti-shopping-habit", title:"MBTI 쇼핑 습관 | 점운 MBTI", desc:"MBTI별 쇼핑 습관 — 각 MBTI 유형이 어떻게 쇼핑하고 소비 결정을 내리는지 분析합니다.", h1:"MBTI 쇼핑 습관 — 유형별 소비 패턴", sub:"MBTI 유형별 쇼핑 습관과 소비 결정 패턴 분析", emoji:"🛍️" },
  { slug:"mbti-social-media", title:"MBTI SNS 사용 패턴 | 점운 MBTI", desc:"MBTI별 SNS 사용 패턴 — 각 MBTI 유형이 소셜미디어를 어떻게 활용하고 어떤 콘텐츠를 좋아하는지 분析합니다.", h1:"MBTI SNS 사용 패턴 — 유형별 소셜미디어 활용", sub:"MBTI 유형별 SNS 사용 패턴과 선호 콘텐츠 분析", emoji:"📱" },
  { slug:"mbti-jealousy-style", title:"MBTI 질투 방식 | 점운 MBTI", desc:"MBTI별 질투 방식 — 각 MBTI 유형이 질투를 느낄 때 어떻게 반응하고 표현하는지 분析합니다.", h1:"MBTI 질투 방식 — 유형별 질투 표현 패턴", sub:"MBTI 유형별 질투 방식과 감정 표현 패턴 분析", emoji:"💚" },
  { slug:"mbti-moving-on-style", title:"MBTI 이별 극복 방식 | 점운 MBTI", desc:"MBTI별 이별 극복 방식 — 각 MBTI 유형이 이별 후 어떻게 감정을 정리하고 회복하는지 분析합니다.", h1:"MBTI 이별 극복 방식 — 유형별 감정 회복 패턴", sub:"MBTI 유형별 이별 극복과 감정 회복 방법 분析", emoji:"💔" },
  { slug:"mbti-first-impression", title:"MBTI 첫인상 | 점운 MBTI", desc:"MBTI별 첫인상 — 각 MBTI 유형이 처음 만났을 때 어떤 인상을 주는지 분析합니다.", h1:"MBTI 첫인상 — 유형별 첫 만남 인상 분析", sub:"MBTI 유형별 첫인상과 첫 만남 인상 완전 분析", emoji:"✨" },
  { slug:"mbti-deep-talk", title:"MBTI 깊은 대화 취향 | 점운 MBTI", desc:"MBTI별 깊은 대화 취향 — 각 MBTI 유형이 어떤 주제의 깊은 대화를 즐기는지 분析합니다.", h1:"MBTI 깊은 대화 취향 — 유형별 딥토크 주제", sub:"MBTI 유형별 깊은 대화 취향과 딥토크 주제 分析", emoji:"💭" },
  { slug:"mbti-weekend-plan", title:"MBTI 주말 계획 스타일 | 점운 MBTI", desc:"MBTI별 주말 계획 스타일 — 각 MBTI 유형이 주말을 어떻게 보내고 무엇을 즐기는지 분析합니다.", h1:"MBTI 주말 계획 스타일 — 유형별 주말 활동", sub:"MBTI 유형별 주말 계획과 여가 활동 스타일 分析", emoji:"🎉" },
  { slug:"mbti-friendship-ending", title:"MBTI 절교 방식 | 점운 MBTI", desc:"MBTI별 절교 방식 — 각 MBTI 유형이 친구 관계를 끊을 때 어떻게 행동하는지 분析합니다.", h1:"MBTI 절교 방식 — 유형별 관계 종료 패턴", sub:"MBTI 유형별 절교 방식과 관계 종료 패턴 분析", emoji:"🚷" },
  { slug:"mbti-team-project", title:"MBTI 팀 프로젝트 역할 | 점운 MBTI", desc:"MBTI별 팀 프로젝트 역할 — 각 MBTI 유형이 팀 작업에서 어떤 역할을 맡고 어떻게 기여하는지 분析합니다.", h1:"MBTI 팀 프로젝트 역할 — 유형별 팀 내 역할", sub:"MBTI 유형별 팀 프로젝트 역할과 기여 방식 分析", emoji:"👥" },
  { slug:"mbti-interview-style", title:"MBTI 면접 스타일 | 점운 MBTI", desc:"MBTI별 면접 스타일 — 각 MBTI 유형이 취업 면접에서 어떻게 행동하고 강점을 어필하는지 분析합니다.", h1:"MBTI 면접 스타일 — 유형별 면접 강점 어필", sub:"MBTI 유형별 면접 스타일과 강점 어필 방법 분析", emoji:"💼" },
  { slug:"mbti-handling-failure", title:"MBTI 실패 대처 방식 | 점운 MBTI", desc:"MBTI별 실패 대처 방식 — 각 MBTI 유형이 실패와 좌절을 어떻게 극복하고 회복하는지 分析합니다.", h1:"MBTI 실패 대처 방식 — 유형별 회복력 패턴", sub:"MBTI 유형별 실패 극복과 회복력 패턴 완전 분析", emoji:"💪" },
  { slug:"mbti-success-definition", title:"MBTI 성공의 정의 | 점운 MBTI", desc:"MBTI별 성공의 정의 — 각 MBTI 유형이 어떤 것을 성공으로 여기고 무엇을 목표로 하는지 분析합니다.", h1:"MBTI 성공의 정의 — 유형별 성공 기준 분析", sub:"MBTI 유형별 성공의 정의와 삶의 목표 완전 분析", emoji:"🏆" },
  { slug:"mbti-in-relationship", title:"MBTI 연애할 때 | 점운 MBTI", desc:"MBTI별 연애 스타일 완전 분析 — 16가지 유형이 사랑에 빠졌을 때 어떻게 행동하는지 상세히 안내합니다.", h1:"MBTI 연애할 때 — 유형별 연애 행동 패턴", sub:"MBTI 16유형별 연애할 때 행동 패턴 완전 분析", emoji:"❤️" },
  { slug:"mbti-when-angry", title:"MBTI 화날 때 | 점운 MBTI", desc:"MBTI별 화났을 때 행동 패턴 — 각 MBTI 유형이 분노를 느낄 때 어떻게 표현하고 해소하는지 분析합니다.", h1:"MBTI 화날 때 행동 — 유형별 분노 표현 패턴", sub:"MBTI 유형별 화났을 때 행동과 분노 해소법 분析", emoji:"😤" },
  { slug:"mbti-when-sad", title:"MBTI 슬플 때 | 점운 MBTI", desc:"MBTI별 슬플 때 행동 패턴 — 각 MBTI 유형이 슬픔과 우울함을 느낄 때 어떻게 반응하는지 분析합니다.", h1:"MBTI 슬플 때 행동 — 유형별 슬픔 처리 패턴", sub:"MBTI 유형별 슬플 때 행동과 슬픔 처리 방법 분析", emoji:"😢" },
  { slug:"mbti-when-excited", title:"MBTI 설렐 때 | 점운 MBTI", desc:"MBTI별 설렐 때 행동 패턴 — 각 MBTI 유형이 기쁨과 설렘을 느낄 때 어떻게 표현하는지 분析합니다.", h1:"MBTI 설렐 때 행동 — 유형별 설렘 표현 패턴", sub:"MBTI 유형별 설렐 때 행동과 기쁨 표현 패턴 분析", emoji:"🥰" },
  { slug:"mbti-self-care", title:"MBTI 자기 관리법 | 점운 MBTI", desc:"MBTI별 자기 관리법 — 각 MBTI 유형에게 맞는 최적의 자기 관리와 셀프케어 방법을 안내합니다.", h1:"MBTI 자기 관리법 — 유형별 최적 셀프케어", sub:"MBTI 유형별 자기 관리와 셀프케어 방법 완전 가이드", emoji:"🧘" },
  { slug:"mbti-alone-time", title:"MBTI 혼자 있는 시간 | 점운 MBTI", desc:"MBTI별 혼자 있는 시간 활용법 — 각 MBTI 유형이 혼자 있을 때 무엇을 하고 어떻게 즐기는지 분析합니다.", h1:"MBTI 혼자 있는 시간 — 유형별 혼자 활동", sub:"MBTI 유형별 혼자 있는 시간 활용법과 활동 分析", emoji:"🧸" },
  { slug:"mbti-in-crisis", title:"MBTI 위기 대처 방식 | 점운 MBTI", desc:"MBTI별 위기 대처 방식 — 각 MBTI 유형이 갑작스러운 위기와 비상 상황에 어떻게 반응하는지 분析합니다.", h1:"MBTI 위기 대처 방식 — 유형별 위기 반응 패턴", sub:"MBTI 유형별 위기 상황 대처 방식과 반응 패턴 分析", emoji:"🚨" },
  { slug:"mbti-travel-packing", title:"MBTI 여행 짐 싸기 | 점운 MBTI", desc:"MBTI별 여행 짐 싸기 스타일 — 각 MBTI 유형이 여행 전 어떻게 짐을 싸고 준비하는지 분析합니다.", h1:"MBTI 여행 짐 싸기 — 유형별 여행 준비 스타일", sub:"MBTI 유형별 여행 짐 싸기와 준비 방식 완전 分析", emoji:"🧳" },
  { slug:"mbti-cooking-style", title:"MBTI 요리 스타일 | 점운 MBTI", desc:"MBTI별 요리 스타일 — 각 MBTI 유형이 어떻게 요리하고 어떤 음식을 즐겨 만드는지 분析합니다.", h1:"MBTI 요리 스타일 — 유형별 요리 접근 방식", sub:"MBTI 유형별 요리 스타일과 선호 음식 완전 분析", emoji:"🍳" },
  { slug:"mbti-gift-giving", title:"MBTI 선물 주는 방식 | 점운 MBTI", desc:"MBTI별 선물 주는 방식 — 각 MBTI 유형이 어떻게 선물을 고르고 특별한 날을 챙기는지 분析합니다.", h1:"MBTI 선물 주는 방식 — 유형별 선물 선택 패턴", sub:"MBTI 유형별 선물 주는 방식과 특별한 날 챙기기 분析", emoji:"🎁" },
  { slug:"mbti-apology-acceptance", title:"MBTI 사과 받는 방식 | 점운 MBTI", desc:"MBTI별 사과 받는 방식 — 각 MBTI 유형이 사과를 받았을 때 어떻게 받아들이고 용서하는지 분析합니다.", h1:"MBTI 사과 받는 방식 — 유형별 용서 패턴", sub:"MBTI 유형별 사과 받는 방식과 용서 패턴 완전 분析", emoji:"🤝" },
  { slug:"mbti-social-battery", title:"MBTI 사회적 배터리 | 점운 MBTI", desc:"MBTI별 사회적 배터리 — 각 MBTI 유형이 사람들과 어울린 후 얼마나 빨리 지치고 회복하는지 분析합니다.", h1:"MBTI 사회적 배터리 — 유형별 사회 활동 체력", sub:"MBTI 유형별 사회적 배터리와 에너지 회복 시간 分析", emoji:"🔋" },
  { slug:"mbti-in-school", title:"MBTI 학창시절 | 점운 MBTI", desc:"MBTI별 학창시절 모습 — 각 MBTI 유형이 학교에서 어떻게 생활하고 어떤 학생이었는지 分析합니다.", h1:"MBTI 학창시절 — 유형별 학교 생활 패턴", sub:"MBTI 유형별 학창시절 모습과 학교 생활 완전 分析", emoji:"🎒" },
  { slug:"mbti-in-office", title:"MBTI 직장에서 | 점운 MBTI", desc:"MBTI별 직장에서의 모습 — 각 MBTI 유형이 직장에서 어떻게 일하고 동료와 어울리는지 分析합니다.", h1:"MBTI 직장에서 — 유형별 직장 생활 패턴", sub:"MBTI 유형별 직장 생활 모습과 동료 관계 완전 分析", emoji:"💼" },
  { slug:"mbti-friendship-type", title:"MBTI 친구 유형 | 점운 MBTI", desc:"MBTI별 친구 유형 — 각 MBTI 유형이 어떤 친구이고 어떻게 우정을 유지하는지 分析합니다.", h1:"MBTI 친구 유형 — 유형별 우정 스타일", sub:"MBTI 유형별 친구 유형과 우정 유지 방식 완전 분析", emoji:"👫" },
  { slug:"mbti-as-parent", title:"MBTI 부모 스타일 | 점운 MBTI", desc:"MBTI별 부모 스타일 — 각 MBTI 유형이 부모로서 어떤 육아 방식과 태도를 보이는지 분析합니다.", h1:"MBTI 부모 스타일 — 유형별 육아 방식 분析", sub:"MBTI 유형별 부모 스타일과 육아 방식 완전 분析", emoji:"👨‍👩‍👧" },
  { slug:"mbti-as-boss", title:"MBTI 상사 스타일 | 점운 MBTI", desc:"MBTI별 상사 스타일 — 각 MBTI 유형이 상사가 됐을 때 어떻게 팀을 이끌고 관리하는지 分析합니다.", h1:"MBTI 상사 스타일 — 유형별 리더십 관리 방식", sub:"MBTI 유형별 상사 스타일과 팀 관리 방식 완전 분析", emoji:"👔" },
  { slug:"mbti-as-employee", title:"MBTI 부하직원 스타일 | 점운 MBTI", desc:"MBTI별 부하직원 스타일 — 각 MBTI 유형이 부하직원으로서 어떻게 일하고 보고하는지 分析합니다.", h1:"MBTI 부하직원 스타일 — 유형별 부하 직원 특성", sub:"MBTI 유형별 부하직원 스타일과 업무 방식 완전 분析", emoji:"👷" },
  { slug:"mbti-money-management", title:"MBTI 돈 관리 방식 | 점운 MBTI", desc:"MBTI별 돈 관리 방식 — 각 MBTI 유형이 돈을 어떻게 관리하고 재정 결정을 내리는지 分析합니다.", h1:"MBTI 돈 관리 방식 — 유형별 재정 관리 패턴", sub:"MBTI 유형별 돈 관리와 재정 결정 방식 완전 분析", emoji:"💰" },
  { slug:"mbti-savings-habit", title:"MBTI 저축 습관 | 점운 MBTI", desc:"MBTI별 저축 습관 — 각 MBTI 유형이 저축과 투자에 어떤 태도를 갖고 얼마나 저축하는지 분析합니다.", h1:"MBTI 저축 습관 — 유형별 저축 투자 패턴", sub:"MBTI 유형별 저축 습관과 투자 태도 완전 分析", emoji:"🏦" },
  { slug:"mbti-exercise-motivation", title:"MBTI 운동 동기 | 점운 MBTI", desc:"MBTI별 운동 동기 — 각 MBTI 유형이 운동을 시작하고 꾸준히 유지하는 동기와 방법을 분析합니다.", h1:"MBTI 운동 동기 — 유형별 운동 지속 방법", sub:"MBTI 유형별 운동 동기와 꾸준한 운동 유지법 분析", emoji:"🏋️" },
  { slug:"mbti-diet-success", title:"MBTI 다이어트 성공법 | 점운 MBTI", desc:"MBTI별 다이어트 성공법 — 각 MBTI 유형에게 가장 잘 맞는 다이어트 방법과 유지 전략을 안내합니다.", h1:"MBTI 다이어트 성공법 — 유형별 최적 다이어트", sub:"MBTI 유형별 다이어트 성공법과 체중 관리 전략 분析", emoji:"🥗" },
  { slug:"mbti-sleep-quality", title:"MBTI 수면 패턴 | 점운 MBTI", desc:"MBTI별 수면 패턴 — 각 MBTI 유형이 어떻게 자고 수면의 질을 높이는 방법을 分析합니다.", h1:"MBTI 수면 패턴 — 유형별 수면 질 향상법", sub:"MBTI 유형별 수면 패턴과 수면 질 향상 방법 분析", emoji:"😴" },
  { slug:"mbti-mental-health", title:"MBTI 정신 건강 관리 | 점운 MBTI", desc:"MBTI별 정신 건강 관리법 — 각 MBTI 유형에게 맞는 정신 건강 관리와 스트레스 해소법을 안내합니다.", h1:"MBTI 정신 건강 관리 — 유형별 멘탈 관리법", sub:"MBTI 유형별 정신 건강 관리와 멘탈 유지 방법 분析", emoji:"🧠" },
  { slug:"mbti-in-2026", title:"2026년 MBTI 트렌드 | 점운 MBTI", desc:"2026년 MBTI 트렌드 — 최신 MBTI 연구와 트렌드를 바탕으로 각 유형별 2026년 성장 방향을 分析합니다.", h1:"2026년 MBTI 트렌드 — 최신 유형별 성장 방향", sub:"2026년 MBTI 최신 트렌드와 유형별 성장 방향 분析", emoji:"📈" },
  { slug:"mbti-complete-guide", title:"MBTI 완전 가이드 | 점운 MBTI", desc:"MBTI 완전 가이드 — 16가지 유형의 모든 것을 한 곳에서 확인하는 완전한 MBTI 안내서.", h1:"MBTI 완전 가이드 — 16유형 모든 것", sub:"MBTI 16유형 완전 가이드와 모든 정보 한눈에 확인", emoji:"📖" },
  { slug:"mbti-for-new-job", title:"새 직장 MBTI 활용법 | 점운 MBTI", desc:"새 직장에서 MBTI 활용법 — 새 직장 첫날부터 동료 유형을 파악하고 관계를 빠르게 구축하는 방법 분析.", h1:"새 직장 MBTI 활용법 — 동료 파악 관계 구축 전략", sub:"새 직장에서 MBTI로 동료 파악하고 빠른 관계 구축하기", emoji:"🏢" },
  { slug:"mbti-and-love-bombing", title:"MBTI 과도한 애정 표현 | 점운 MBTI", desc:"MBTI 과도한 애정 표현 패턴 — 어떤 MBTI 유형이 처음에 과도한 애정을 쏟아붓는지 分析합니다.", h1:"MBTI 과도한 애정 표현 — 유형별 연애 시작 패턴", sub:"MBTI 유형별 처음 만났을 때 과도한 애정 표현 패턴 분析", emoji:"💝" },
  { slug:"mbti-phone-habit", title:"MBTI 전화 습관 | 점운 MBTI", desc:"MBTI별 전화 습관 — 어떤 MBTI 유형이 전화를 선호하고 어떤 유형이 문자를 선호하는지 분析합니다.", h1:"MBTI 전화 습관 — 유형별 통화 선호 패턴", sub:"MBTI 유형별 전화·문자 선호 습관과 소통 패턴 분析", emoji:"📞" },
  { slug:"mbti-vacation-planning", title:"MBTI 휴가 계획 방식 | 점운 MBTI", desc:"MBTI별 휴가 계획 방식 — 각 MBTI 유형이 어떻게 휴가를 계획하고 어떤 여행을 즐기는지 分析합니다.", h1:"MBTI 휴가 계획 방식 — 유형별 여행 계획 스타일", sub:"MBTI 유형별 휴가 계획 방식과 선호 여행 스타일 분析", emoji:"✈️" },
