    ...
    <main ref={pageRef} style={{ minHeight: "100vh", background: BG, fontFamily: "'Apple SD Gothic Neo', 'Malgun Gothic', sans-serif" }}>
      ...
      <div style={{ maxWidth: 480, margin: "0 auto", padding: "20px 16px 80px" }}>
        ...
        {!entry.businessName && (
          ...
          }} style={{ marginTop: 8, marginBottom: 10, borderRadius: 20, overflow: "hidden", boxShadow: "0 10px 36px rgba(139,92,246,0.2)", border: "1.5px solid #e9d5ff", background: "#f9f5ff", cursor: "pointer" }}>
