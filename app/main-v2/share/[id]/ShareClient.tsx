    ...
    <main ref={pageRef} style={{ minHeight: "100vh", background: BG, fontFamily: "'Apple SD Gothic Neo', 'Malgun Gothic', sans-serif" }}>
      ...
      <div style={{ maxWidth: 480, margin: "0 auto", padding: "20px 16px 80px" }}>
        ...
        {!entry.businessName && (
          <div onClick={() => {
          ...
          }} style={{ position: "relative", height: 180, borderRadius: 20, overflow: "hidden", cursor: "pointer", marginBottom: 10, boxShadow: "0 6px 28px rgba(139,92,246,0.25)" }}>
            ...
            <div style={{ position: "absolute", bottom: 20, left: 18, zIndex: 3 }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                ...
                <span style={{ background: "white", color: "#ef4444", fontSize: 11, fontWeight: 900, padding: "5px 12px", borderRadius: 50, display: "inline-block", animation: "scBadgePulse 1.2s ease-in-out infinite" }}>매일 무료 3회</span>
              </div>
            </div>
          </div>
        )}
