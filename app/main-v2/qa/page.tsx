...
const CATEGORY_KEYWORDS: Record<string, string[]> = {
  wealth:   ["돈", "재물", "금전", "수입", "월급", "투자", "부업", "대출", "저축", "재테크", "빚", "수익", "벌", "사업비", "집", "마련", "부동산", "아파트", "전세", "월세"],
  love:     ["연애", "사랑", "남자", "여자", "남친", "여친", "썸", "고백", "헤어", "좋아하는", "만남", "소개팅"],
  marriage: ["결혼", "배우자", "남편", "아내", "혼인", "혼수", "시댁", "처가", "신혼", "프러포즈"],
  business: ["사업", "창업", "장사", "비즈니스", "가게", "직원", "매출", "거래"],
  career:   ["취업", "직장", "회사", "이직", "면접", "커리어", "승진", "직업", "일자리", "자격증", "시험", "공부"],
  success:  ["성공", "목표", "꿈", "인생", "운", "기회", "도전", "변화", "성과"],
  health:   ["건강", "병", "몸", "아프", "수술", "병원", "체력", "스트레스", "피로", "다이어트"],
  children: ["자녀", "아이", "아기", "임신", "출산", "육아", "자식"],
  general:  ["평안", "마음", "기분", "요즘", "어떻게", "전반적", "내년"],
};
