...
export default function V2Profile() {
  ...
  return (
    <main style={{ minHeight: "100vh", backgroundImage: `url('https://i.pinimg.com/1200x/ef/d7/c3/efd7c3a7c5b44c9af7e7dfe1d03763c1.jpg'), ${BG}`, backgroundSize: "cover", backgroundPosition: "center", backgroundAttachment: "fixed", fontFamily: "'Apple SD Gothic Neo', 'Malgun Gothic', sans-serif" }}>
