...
export default function HistoryDetail() {
  ...
  return (
    ...
    />
    <main style={{ minHeight: "100vh", background: BG, backgroundImage: "url('https://i.pinimg.com/1200x/5d/22/92/5d229205a38416f2974c6b17f3c8bf35.jpg')", backgroundSize: "cover", backgroundPosition: "center", backgroundAttachment: "fixed", fontFamily: "'Apple SD Gothic Neo', 'Malgun Gothic', sans-serif" }}>
