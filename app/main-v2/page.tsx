...
const FORTUNE_CATEGORIES = [
  ...
  { id: "dateselect",    title: "택일",            sub: "택일",               emoji: "📅", img: "https://i.pinimg.com/736x/8c/d5/cb/8cd5cb716cc5ad25ada38aa88306c52d.jpg", bg: "linear-gradient(145deg, #f0f9ff, #bae6fd)", accent: "#0284c7", price: "출시예정",   priceBg: "#0ea5e9", badgeSide: "right" },
  ...
  { id: "health",        title: "건강운",           sub: "건강운", emoji: "🍀", img: "https://i.pinimg.com/1200x/55/63/35/55633536dcf4915221fbbfbd14fba5e2.jpg", bg: "linear-gradient(145deg, #dcfce7, #bbf7d0)", accent: "#16a34a", price: "프리미엄", priceBg: "#15803d", badgeSide: "right" },
