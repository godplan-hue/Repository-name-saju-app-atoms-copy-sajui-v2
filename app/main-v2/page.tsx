...
const FORTUNE_CATEGORIES = [
  ...
  { id: "naming",        title: "이름분석",          sub: "5개 운세 묶음",      emoji: "✍️", img: "https://i.pinimg.com/1200x/23/01/49/2301499ea90a65609becd809e3554796.jpg", bg: "linear-gradient(145deg, #ecfeff, #cffafe)", accent: "#0e7490", price: "₩3,900",     priceBg: "#ff0000" },
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 10 }}>
        {EXTRA_ITEMS.map(item => (
          <div key={item.id} onClick={() => onPick(item.id)} style={{ aspectRatio: "1 / 1", borderRadius: 14, cursor: "pointer", position: "relative", overflow: "hidden", boxShadow: `0 3px 12px ${item.accent}28` }}>
            ...
            <span style={{ position: "absolute", top: 5, left: 5, fontSize: 9, fontWeight: 900, padding: "2px 7px", borderRadius: 20, ...(item.priceNum === 990 ? { background: "#ef4444", color: "#fff" } : { background: "rgba(255,255,255,0.92)", color: "#6b21a8", border: "1px solid rgba(255,255,255,0.6)" }) }}>{item.price}</span>
