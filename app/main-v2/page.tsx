      ...
      >
        {(b as any).graphic ? (
          ...
          <div style={{ position: "absolute", inset: 0 }}>
            ...
            <div style={{ position: "absolute", top: 18, right: 18, width: 200, height: 135, borderRadius: "50%", border: "5px solid #fbbf24", background: "linear-gradient(160deg, #ffd6e8, #f3e8ff)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", boxShadow: "0 6px 20px rgba(109,40,217,0.35), inset 0 0 0 2px rgba(255,255,255,0.6)" }}>
              ...
              <span style={{ fontSize: 12, fontWeight: 800, marginTop: 5 }}>
                <span style={{ color: "#16a34a" }}>오늘의 운세</span>{" "}
