...
const EXTRA_ITEMS = [
  ...
  { id: "taegil",           label: "택일(擇日)",       sub: "내 사주에 맞는 좋은 날",  emoji: "📅", price: "₩3,900", priceNum: 3900, premium: false, img: "https://i.pinimg.com/736x/13/fe/fe/13fefe5771413426b625b2a27a4afe8e.jpg", accent: "#0284c7" },
