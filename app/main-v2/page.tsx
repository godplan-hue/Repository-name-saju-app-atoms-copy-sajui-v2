      ...
      >
        {(b as any).graphic ? (
          ...
          <div style={{ position: "absolute", inset: 0 }}>
            ...
            <span style={{ position: "absolute", top: 14, left: 16, display: "inline-block", background: "#facc15", color: "#c2410c", fontSize: 12, fontWeight: 900, padding: "5px 13px", borderRadius: 20, zIndex: 2 }}>무료 사주</span>
