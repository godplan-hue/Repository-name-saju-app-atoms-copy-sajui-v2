...
export default function PartnerApply() {
  ...
  const tiers = [
    ...
    { name: "다이아", fee: "₩980,000", month: "무제한", revenue: "70%", value: "diamond" }
  ];
  ...
  return (
    <main style={{ minHeight: "100vh", background: "linear-gradient(135deg, #0f0620 0%, #1a0f35 50%, #0a0420 100%)", backgroundImage: "url('https://i.pinimg.com/736x/1d/f4/5c/1df45ceec7fc4785fe791128c06b2f16.jpg')", backgroundSize: "cover", backgroundPosition: "center", backgroundAttachment: "fixed", color: "white", fontFamily: "'Apple SD Gothic Neo', 'Malgun Gothic', sans-serif", position: "relative", overflow: "hidden" }}>
