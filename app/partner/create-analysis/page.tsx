...
export default function PartnerCreateAnalysis() {
  ...
  const packages = [
    { name: "기본 분석", price: "₩9,900", desc: ["재물운", "+ 연애운"] },
    { name: "베이직", price: "₩19,900", desc: ["올해 운세", "+ 재물운", "+ 연애운", "+ 월별 운세"] },
    { name: "프리미엄", price: "₩24,900", desc: ["올해 운세", "+ 재물운", "+ 연애운", "+ 월별 운세", "+ 건강운"] },
    { name: "VIP 커플팩", price: "₩29,900", desc: ["이름분석", "+ 올해 운세", "+ 재물운", "+ 연애운", "+ 건강운", "+ 궁합분석", "+ 월별 운세", "+ 전체 사주분석"] },
  ];
