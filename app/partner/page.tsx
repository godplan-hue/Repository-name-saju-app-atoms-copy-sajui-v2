...
export default function PartnerLanding() {
  ...
  return (
    <main style={{ minHeight: "100vh", background: "linear-gradient(135deg, #0f0620 0%, #1a0f35 50%, #0a0420 100%)", backgroundImage: "url('https://i.pinimg.com/1200x/c0/c4/ef/c0c4ef944761a32601f11c8879aff9f4.jpg')", backgroundSize: "cover", backgroundPosition: "center", backgroundAttachment: "fixed", color: "white", fontFamily: "'Apple SD Gothic Neo', 'Malgun Gothic', sans-serif", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", zIndex: 10 }}>
        ...
        <footer style={{ padding: "30px 16px", textAlign: "center", borderTop: "1px solid rgba(245,158,11,0.2)", background: "rgba(0,0,0,0.2)" }}>
          ...
          <div style={{ color: "#e9d5a8", fontSize: 12, fontWeight: 700, lineHeight: 1.8, marginBottom: 14 }}>
            ...
            <a href="mailto:junga6783@gmail.com?subject=점운 파트너 문의" style={{ display: "inline-block", padding: "6px 18px", border: "1.5px solid #fbbf24", borderRadius: 20, color: "#fbbf24", textDecoration: "none", fontWeight: 800, fontSize: 12 }}>문의하기</a>
          </div>
