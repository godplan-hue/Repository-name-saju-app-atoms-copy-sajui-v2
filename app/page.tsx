      ...
      <section style={{ padding: "40px 24px" }}>
        <div style={{ maxWidth: 1400, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 40 }}>
          ...
          <div>
            ...
            <a href="/analyze" style={{ display: "block", background: "linear-gradient(135deg,rgba(139,92,246,0.15),rgba(49,46,129,0.1))", border: "1px solid rgba(139,92,246,0.3)", borderRadius: 12, padding: "14px", textDecoration: "none", display: "flex", justifyContent: "space-between", alignItems: "center", cursor: "pointer", marginBottom: 20 }}>
            ...
            <a href="/analyze" style={{ display: "block", background: "linear-gradient(135deg,#f59e0b,#d97706)", color: "black", padding: "14px 20px", borderRadius: 12, fontSize: 17, fontWeight: 900, textDecoration: "none", textAlign: "center", boxShadow: "0 8px 30px rgba(245,158,11,0.5)" }}>🔮 지금 바로 분석하기</a>
          </div>
        </div>
      </section>
    </main>
