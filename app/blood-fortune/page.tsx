  ...
  return (
    <main style={{ minHeight: "100vh", background: "#fff1f2", fontFamily: "'Apple SD Gothic Neo', 'Malgun Gothic', sans-serif", color: "#1f2937" }}>
      <div style={{ background: "linear-gradient(135deg, #ffe4e6, #fff1f2)", padding: "60px 20px 48px", textAlign: "center" }}>
        ...
        <h1 style={{ fontSize: "clamp(26px,5vw,40px)", fontWeight: 900, margin: "0 0 12px", lineHeight: 1.25 }}>내 혈액형으로 보는<br />2026년 운세</h1>
      ...
      <div style={{ maxWidth: 600, margin: "0 auto", padding: "40px 20px" }}>
        {[{ type: "A형", desc: "꼼꼼하고 성실한 A형. 2026년 안정과 신중함이 키워드.", color: "#ef4444" }, { type: "B형", desc: "자유롭고 창의적인 B형. 2026년 새로운 도전의 해.", color: "#f97316" }, { type: "O형", desc: "리더십 강한 O형. 2026년 관계와 협력이 중요.", color: "#eab308" }, { type: "AB형", desc: "독특하고 이중적인 AB형. 2026년 내면 성장의 해.", color: "#8b5cf6" }].map(b => (
