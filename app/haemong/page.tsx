  ...
  return (
    <main style={{ minHeight: "100vh", background: BG, backgroundImage: `url('https://i.pinimg.com/1200x/31/e5/d0/31e5d07256c46586a7a89977f720b96f.jpg')`, backgroundSize: "cover", backgroundPosition: "center", backgroundAttachment: "fixed", fontFamily: "'Apple SD Gothic Neo', 'Malgun Gothic', sans-serif", overflowX: "hidden" }}>
      ...
      <div style={{ maxWidth: 480, margin: "0 auto", padding: "16px 14px 80px" }}>
        ...
        {/* 크몽·탈잉 신뢰 문구 */}
        <p style={{ textAlign: "center", fontSize: 12, color: "#f97316", fontWeight: 900, marginBottom: 14, letterSpacing: "0.02em" }}>
          <span style={{ background: "rgba(255,255,255,0.9)", borderRadius: 8, padding: "3px 10px", display: "inline-block" }}>🏆 탈잉 2년 연속 1위 · 크몽 상위 2% 프라임</span><br />
          <span style={{ background: "rgba(255,255,255,0.9)", borderRadius: 8, padding: "3px 10px", display: "inline-block", marginTop: 4 }}>기획의신 에스더(Esther)가 직접 만들고 검증한 앱</span>
        </p>
